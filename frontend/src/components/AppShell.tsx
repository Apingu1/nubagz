...
import { Compass, LayoutDashboard, Trophy, BriefcaseBusiness, Shield, LogOut, WalletCards, Zap, BadgePoundSterling, Gift, CalendarDays } from 'lucide-react'
import { Logo } from './Logo'
import { useAuth } from '../context/AuthContext'

export default function AppShell(){
 const {user,logout}=useAuth(); const nav=useNavigate()
 const items=[['/app','Home',LayoutDashboard],['/app/daily','Daily Earn',CalendarDays],['/app/discover','Discover',Compass],['/app/drops','BagDrops',Gift],['/app/earnings','Earnings',BadgePoundSterling],['/app/bag','My Bag',WalletCards],['/app/leaderboard','Leaderboard',Trophy],['/app/studio','Creator Studio',BriefcaseBusiness]] as const
