...
export default function App(){return <Routes><Route path="/" element={<Landing/>}/><Route path="/login" element={<Auth mode="login"/>}/><Route path="/register" element={<Auth mode="register"/>}/><Route path="/wallet-setup" element={<Protected><WalletOnboarding/></Protected>}/><Route path="/app" element={<Protected><AppShell/></Protected>}><Route index element={<Dashboard/>}/><Route path="daily" element={<DailyEarn/>}/><Route path="discover" element={<Discover/>}/><Route path="drops" element={<BagDrops/>}/><Route path="onchain" element={<OnchainLab/>}/><Route path="trust" element={<TrustCenter/>}/><Route path="account-trust" element={<AccountTrust/>}/><Route path="bagz/:id" element={<BagDetail/>}/><Route path="bag" element={<MyBag/>}/><Route path="earnings" element={<Earnings/>}/><Route path="leaderboard" element={<Leaderboard/>}/><Route path="studio" element={<CreatorStudio/>}/><Route path="studio/projects/new" element={<CreateProject/>}/><Route path="studio/campaigns/new" element={<CreateCampaign/>}/><Route path="admin" element={<AdminOnly/>}/></Route><Route path="*" element={<Navigate to="/"/>}/></Routes>}
