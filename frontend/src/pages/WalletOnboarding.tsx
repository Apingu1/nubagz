...
function PayoutOnlySetup({onSaved}:{onSaved:()=>void}){
  const [address,setAddress]=useState(''); const [chain,setChain]=useState('Avalanche'); const [busy,setBusy]=useState(false); const [msg,setMsg]=useState('')
