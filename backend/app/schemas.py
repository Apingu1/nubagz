...
class MissionCreate(BaseModel):
    ...
    verification_type: str = "SELF_ATTEST"
...
class CampaignCreate(BaseModel):
    ...
    missions: list[MissionCreate] = Field(min_length=1)
    ...
    def shares_total(self):
        ...
        required = self.gross_reward_per_user * self.max_users
        if required > self.token_allocation:
