...
from .routers import auth, projects, campaigns, users, admin, funding, earnings, prices, bagdrops, daily, onchain
...
@app.get("/api/health")
def health():
    return {"status": "ok", "service": "nubagz-api", "version": "1.6.0"}
